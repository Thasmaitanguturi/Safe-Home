...
window = tk.Tk()
window.title("Safe Home")
window.iconphoto(False, tk.PhotoImage(file='mn.png'))
window.geometry('1080x700')
window.configure(bg='#0B2C41')  

frame1 = tk.Frame(window, bg='#0B2C41') 

label_title = tk.Label(frame1, text="Safe Home", bg='#0B2C41', fg='white')
...
label_icon = tk.Label(frame1, image=icon, bg='#0B2C41')
...
btn1 = tk.Button(frame1, text='Stolen', height=90, width=180, fg='green', command=find_motion, image=btn1_image, compound='left', bg='#0B2C41')
btn1['font'] = btn_font
btn1.grid(row=3, pady=(20, 10))

btn2 = tk.Button(frame1, text='Restricted', height=90, width=180, fg='green', command=rect_noise, compound='left', image=btn2_image, bg='#0B2C41')
btn2['font'] = btn_font
btn2.grid(row=3, pady=(20, 10), column=3, padx=(20, 5))

btn_font = font.Font(size=25)
btn3 = tk.Button(frame1, text='Motion', height=90, width=180, fg='green', command=noise, image=btn3_image, compound='left', bg='#0B2C41')
btn3['font'] = btn_font
btn3.grid(row=5, pady=(20, 10))

btn4 = tk.Button(frame1, text='Record', height=90, width=180, fg='green', command=record, image=btn4_image, compound='left', bg='#0B2C41')
btn4['font'] = btn_font
btn4.grid(row=5, pady=(20, 10), column=3)

btn6 = tk.Button(frame1, text='In Out', height=90, width=180, fg='green', command=in_out, image=btn6_image, compound='left', bg='#0B2C41')
btn6['font'] = btn_font
btn6.grid(row=5, pady=(20, 10), column=2)

btn5 = tk.Button(frame1, height=90, width=180, fg='red', command=window.quit, image=btn5_image, bg='#0B2C41')
btn5['font'] = btn_font
btn5.grid(row=6, pady=(20, 10), column=2)

btn7 = tk.Button(frame1, text="Identify", fg="orange", command=maincall, compound='left', image=btn7_image, height=90, width=180, bg='#0B2C41')
btn7['font'] = btn_font
